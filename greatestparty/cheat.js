...
function cheatSTR(value) { game.party.strbase = value == null ? 18 : value; }
function cheatDEX(value) { game.party.dexbase = value == null ? 18 : value; }
function cheatCON(value) { game.party.conbase = value == null ? 18 : value; }
function cheatINT(value) { game.party.intbase = value == null ? 18 : value; }
function cheatWIS(value) { game.party.wisbase = value == null ? 18 : value; }
function cheatCHA(value) { game.party.chabase = value == null ? 18 : value; }
function cheatStats(value) {
    cheatSTR(value);
    cheatDEX(value);
    cheatCON(value);
    cheatINT(value);
