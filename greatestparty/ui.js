"use strict";
const _getElementByIdHistory = new Set();
...
function getElementByIdAsType(id, clazz) {
...
class UIEquipment {
    ...
    onChange(e) {
        ...
        if (e.target instanceof HTMLInputElement && !e.target.disabled) {
            ...
            let decreased = false;
            const conf = typ == 'weapon' ? this.weaponConfig : this.armorConfig;
            for (let n = 2; n > num; --n) {
        ...
        if (this.weaponConfig.blunt[2].checked) {
            this.game.party.weaponConfig.physical = -3;
        }
        else if (this.weaponConfig.slice[2].checked) {
            this.game.party.weaponConfig.physical = 3;
        }
        else if (this.weaponConfig.blunt[1].checked) {
            this.game.party.weaponConfig.physical = -2;
        }
        else if (this.weaponConfig.slice[1].checked) {
            this.game.party.weaponConfig.physical = 2;
        }
        else if (this.weaponConfig.blunt[0].checked) {
            this.game.party.weaponConfig.physical = -1;
        }
        else if (this.weaponConfig.slice[0].checked) {
            this.game.party.weaponConfig.physical = 1;
        }
        else {
            this.game.party.weaponConfig.physical = 0;
        }
        if (this.weaponConfig.dark[2].checked) {
            this.game.party.weaponConfig.magical = -3;
        }
        else if (this.weaponConfig.light[2].checked) {
            this.game.party.weaponConfig.magical = 3;
        }
        else if (this.weaponConfig.dark[1].checked) {
            this.game.party.weaponConfig.magical = -2;
        }
        else if (this.weaponConfig.light[1].checked) {
            this.game.party.weaponConfig.magical = 2;
        }
        else if (this.weaponConfig.dark[0].checked) {
            this.game.party.weaponConfig.magical = -1;
        }
        else if (this.weaponConfig.light[0].checked) {
            this.game.party.weaponConfig.magical = 1;
        }
        else {
            this.game.party.weaponConfig.magical = 0;
        }
        if (this.weaponConfig.fire[2].checked) {
            this.game.party.weaponConfig.elemental = -3;
        }
        else if (this.weaponConfig.ice[2].checked) {
            this.game.party.weaponConfig.elemental = 3;
        }
        else if (this.weaponConfig.fire[1].checked) {
            this.game.party.weaponConfig.elemental = -2;
        }
        else if (this.weaponConfig.ice[1].checked) {
            this.game.party.weaponConfig.elemental = 2;
        }
        else if (this.weaponConfig.fire[0].checked) {
            this.game.party.weaponConfig.elemental = -1;
        }
        else if (this.weaponConfig.ice[0].checked) {
            this.game.party.weaponConfig.elemental = 1;
        }
        else {
            this.game.party.weaponConfig.elemental = 0;
        }
        if (this.armorConfig.blunt[2].checked) {
            this.game.party.armorConfig.physical = -3;
        }
        else if (this.armorConfig.slice[2].checked) {
            this.game.party.armorConfig.physical = 3;
        }
        else if (this.armorConfig.blunt[1].checked) {
            this.game.party.armorConfig.physical = -2;
        }
        else if (this.armorConfig.slice[1].checked) {
            this.game.party.armorConfig.physical = 2;
        }
        else if (this.armorConfig.blunt[0].checked) {
            this.game.party.armorConfig.physical = -1;
        }
        else if (this.armorConfig.slice[0].checked) {
            this.game.party.armorConfig.physical = 1;
        }
        else {
            this.game.party.armorConfig.physical = 0;
        }
        if (this.armorConfig.dark[2].checked) {
            this.game.party.armorConfig.magical = -3;
        }
        else if (this.armorConfig.light[2].checked) {
            this.game.party.armorConfig.magical = 3;
        }
        else if (this.armorConfig.dark[1].checked) {
            this.game.party.armorConfig.magical = -2;
        }
        else if (this.armorConfig.light[1].checked) {
            this.game.party.armorConfig.magical = 2;
        }
        else if (this.armorConfig.dark[0].checked) {
            this.game.party.armorConfig.magical = -1;
        }
        else if (this.armorConfig.light[0].checked) {
            this.game.party.armorConfig.magical = 1;
        }
        else {
            this.game.party.armorConfig.magical = 0;
        }
        if (this.armorConfig.fire[2].checked) {
            this.game.party.armorConfig.elemental = -3;
        }
        else if (this.armorConfig.ice[2].checked) {
            this.game.party.armorConfig.elemental = 3;
        }
        else if (this.armorConfig.fire[1].checked) {
            this.game.party.armorConfig.elemental = -2;
        }
        else if (this.armorConfig.ice[1].checked) {
            this.game.party.armorConfig.elemental = 2;
        }
        else if (this.armorConfig.fire[0].checked) {
            this.game.party.armorConfig.elemental = -1;
        }
        else if (this.armorConfig.ice[0].checked) {
            this.game.party.armorConfig.elemental = 1;
        }
        else {
            this.game.party.armorConfig.elemental = 0;
        }
        return false;
    }
    show() {
