...
class Game {
        ...
        this.events = [
            {
                name: 'Err\'s Whisper',
                weight: 1,
                predicate: (game) => clockIsSign(game, Sign.Err),
                action: (game) => {
                    const TERMS = 5;
            ...
            },
            {
                name: 'Goh\'s Whisper',
                weight: 1,
                predicate: (game) => clockIsSign(game, Sign.Goh),
                action: (game) => {
            ...
            },
            {
                name: 'Yurn\'s Whisper',
                weight: 1,
                predicate: (game) => clockIsSign(game, Sign.Yurn),
                action: (game) => {
                    const positive = rollBoolean();
            ...
            },
            {
                name: 'Joyn\'s Whisper',
                weight: 1,
                predicate: (game) => clockIsSign(game, Sign.Joyn),
                action: (game) => {
            ...
            },
            {
                name: 'Ryna\'s Whisper',
                weight: 1,
                predicate: (game) => clockIsSign(game, Sign.Ryna),
                action: (game) => {
            ...
            },
            {
                name: 'Sil\'s Whisper',
                weight: 1,
                predicate: (game) => clockIsSign(game, Sign.Sil),
                action: (game) => {
    ...
    killTownsfolkWithMessage(count, message) {
        if (count > 0) {
            if (this.town.townsfolk >= count) {
                this.town.townsfolk -= count;
            }
    ...
    adjustPartyEquipmentRelative(weapon, armor) {
