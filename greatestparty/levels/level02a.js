...
game.registerLevel({
    ...
    newTown: (game) => {
        ...
        const FOOD_SUPPORT_NORMAL = [25, 30, 40, 15];
        const FOOD_SUPPORT_DESERT = [1, 0, 0, 1];
        const WATER_SUPPORT_NORMAL = [30, 15, 20, 20];
        const WATER_SUPPORT_DESERT = [1, 0, 0, 1];
        const BRANCHES = [
            'twisting switch',
            'bent limb',
            'bushy leafage',
        ...
        function gainDesertKnowledge(amount) {
        ...
        town.events = [
            {
                ...
                weight: 1,
                predicate: (game) => townState.partyInDesert,
                action: (game) => {
            ...
            },
            {
                ...
                weight: 1,
                predicate: (game) => game.town.townsfolk > 0,
                action: (game) => {
        ...
        town.quests = [
            ...
            },
            {
                ...
                weight: 1,
                predicate: (game) => !townState.partyInDesert && !townState.crispin1Done,
                action: (game) => {
                    ...
                    if (r <= 3) {
                        ...
                        switch (++townState.crispin1Gossip) {
                            case 1:
                                saying = 'Brigands inside the town? I can hardly believe it.';
                                break;
                            case 2:
                                saying = 'There\'s been a rash of disappearances lately, did you know that? Why, Markle, just down the way ain\'t been seen in two weeks.';
                                break;
                            case 3:
                                saying = 'I saw Markle a couple weeks back at the Dixie and Dox for supper, normal as he ever was.';
                                break;
                            case 4:
                                saying = 'Maybe brigands took him, maybe he fell down a hole, I dunno. Nobody around here took Markle for the split the town type.';
                                break;
                            case 5:
                                saying = 'I\'d certainly pitch in some coin if you adventuring types found any word about what\'s been going on around here.';
                                break;
                        }
            ...
            },
            {
                ...
                weight: 1,
                predicate: (game) => !townState.partyInDesert && townState.crispin1Done && !townState.crispin2Done,
                action: (game) => {
                        ...
                        if (r <= 4) {
                            ...
                            if (townState.crispin2Hauling == 0) {
                                ...
                                switch (++townState.crispin2WoodDelivered) {
                                    case 1:
                                        saying = 'This is a fine specimine! I know just what to do with it!';
                                        break;
                                    case 2:
                                        saying = 'Just imagine how ornate this would look with a nice dark stain, it would really bring the grain to life.';
                                        break;
                                    case 3:
                                        saying = 'Wow! I never thought I\'d get my hands on some of this!';
                                        break;
                                }
                    ...
                    if (r <= 4) {
                        ...
                        switch (++townState.dixieGossip) {
                            case 1:
                                ...
                                break;
                            case 2:
                                saying = 'I can\'t believe you actually made it back!';
                                break;
                            case 3:
                                saying = 'You all have been to the desert, haven\'t you?';
                                break;
                            case 4:
                                saying = 'I\'ve never seen these so fresh! This is going to start a riot!';
                                break;
                            case 5:
                                saying = 'If you want more medicinal plants, you can find them on the outskirts of the desert.';
                                break;
                        }
            ...
            },
            {
                ...
                weight: 1,
                predicate: (game) => !townState.partyInDesert && townState.dixieDone && !townState.doxDone,
                action: (game) => {
                    ...
                    if (r <= 5) {
                        ...
                        switch (++townState.doxMeatDelivered) {
                            case 1:
                                saying = 'Is your mouth watering? I know mine is!';
                                break;
                            case 2:
                                saying = 'Dixie can eat it, then eat some of this!';
                                break;
                            case 3:
                                saying = 'I\'ve got a special sauce for this slab of meat!';
                                break;
                            case 4:
                                saying = 'Who wants to eat vegetables anyway?';
                                break;
                            case 5:
                                saying = 'MORE MEAT!';
                                break;
                            case 6:
                                saying = 'If I take any more meat, it\'s going to spoil before I can serve it.';
                                break;
                        }
            ...
            },
            {
                ...
                weight: 1,
                predicate: (game) => !townState.partyInDesert && townState.doxDone && townState.crispin2Done && !townState.duke1Done,
                action: (game) => {
                    const scenario = rollChoice([
                        {
                    ...
                    if (r <= 10) {
                        ...
                        switch (++townState.duke1CluesFound) {
                            case 1:
                                clue = 'Clue: The ruffians take their captives eastward out of town.';
                                break;
                            case 2:
                                clue = 'Clue: The ruffians are being paid by someone.';
                                break;
                            case 4:
                                clue = 'Clue: The ruffians show signs that they camp in some place muddy.';
                                break;
                            case 3:
                                clue = 'Clue: The ruffians use old, damaged, but formerly fine weaponry and armor.';
                                break;
                            case 5:
                                clue = 'Clue: The ruffians are camped near Sam\'s Torrent.';
                                break;
                        }
                        game.log(clue);
                    }
            ...
            },
            {
                name: 'Wix Waypoint',
                weight: 1,
                predicate: (game) => !townState.partyInDesert && townState.duke1Done && !townState.wixDone,
                action: (game) => {
            ...
            },
            {
                name: 'Verees Desert',
                weight: 1,
                predicate: (game) => !townState.partyInDesert && townState.duke1Done && !townState.vereesDone,
                action: (game) => {
            ...
            },
            {
                name: 'Duke It Out',
                weight: 1,
                predicate: (game) => !townState.partyInDesert && townState.wixDone && townState.vereesDone && !townState.duke2Done,
                action: (game) => {
                        ...
                        events: [
                            {
                                name: 'Charge',
                                weight: 1,
                                predicate: (game) => state.chargeLevel < MAX_CHARGE,
                                action: (game) => {
                    ...
                    return {
                        ...
                        events: [
                            ...
                            },
                            {
                                name: 'Smash',
                                weight: 1,
                                predicate: (game) => !state.burrow && !state.vortex,
                                action: (game) => {
...
//# sourceMappingURL=level02a.js.map