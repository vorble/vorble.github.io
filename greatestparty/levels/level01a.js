...
game.registerLevel({
    ...
    newTown: (game) => {
        ...
        function maybeInflictIslandCurse(game) {
        ...
        town.events = [
            ...
            },
            {
                name: 'Beloved Heroes',
                weight: 1,
                predicate: (game) => game.town.alignment >= 40,
                action: (game) => {
                    const roll = (rollDie(20)
            ...
            },
            {
                name: 'Fall Squall',
                weight: 1,
                predicate: (game) => clockIsFall(game),
                action: (game) => {
            ...
            },
            {
                ...
                weight: 1,
                predicate: (game) => clockIsSpring(game),
                action: (game) => {
                    const r = rollDie(20) + modLinear(game.party.con, 8);
                    if (r <= 10) {
        ...
        town.quests = [
            ...
            },
            {
                ...
                action: (game) => {
                    if (!townState.questHermitRockIntroduced) {
                        game.log('You come across a hermit living on the other side of the hills outside of town.'
                    ...
                    if (roll <= 2) {
                        ...
                        if (roll >= 12) {
                            ...
                            switch (++townState.questHermitRockGood) {
                                case 1:
                                    saying = 'Yes, yes. This was what I was going for.';
                                    break;
                                case 2:
                                    saying = 'I was already tired of your last arrangement, but this is fine.';
                                    break;
                                case 3:
                                    saying = 'Say, are there fewer of you this time? This is design is quite refreshing.';
                                    break;
                                case 4:
                                    saying = 'This place is really starting to come together.';
                                    break;
                                case 5:
                                    saying = 'This is perfection!';
                                    break;
                            }
            ...
            },
            {
                ...
                action: (game) => {
                    if (!townState.questKidShellIntroduced) {
                        game.log('Your party comes across a pair of youths scouring the white beach for big sea shells.'
                        ...
                        if (kind == 'monsterous') {
                            ...
                            if (townState.questKidShellTalk < 5) {
                                ...
                                switch (++townState.questKidShellTalk) {
                                    case 1:
                                        sayer = 'Maria';
                                        saying = 'James can run really fast and he always finds the good shells! Yours is pretty good though!';
                                        break;
                                    case 2:
                                        sayer = 'James';
                                        saying = 'Maria really appreciates it when I play with her since her dad died.';
                                        break;
                                    case 3:
                                        sayer = 'Maria';
                                        saying = 'James is always in trouble with his parents! My mom say\'s I\'m the most well behaved daughter anyone has ever had!';
                                        break;
                                    case 4:
                                        sayer = 'James';
                                        saying = 'My parents are really hard on me, but I\'m the only friend Maria has so I sneak away from home sometimes to play.';
                                        break;
                                    case 5:
                                        sayer = 'Maria';
                                        saying = 'My dad said there was a ginormous shell somewhere on this beach!';
                                        break;
                                }
                    ...
                    if (roll <= 3) {
                        ...
                        if (townState.questCliffsCliffTalk < 5) {
                            ...
                            switch (++townState.questCliffsCliffTalk) {
                                case 1:
                                    saying = 'Maybe it was just a little farther down.';
                                    break;
                                case 2:
                                    saying = 'Or was it over there?';
                                    break;
                                case 3:
                                    saying = 'When I was fishing I saw it about three quarters of the way up this cliff, or was it half way?';
                                    break;
                                case 4:
                                    saying = 'When we find the inlet, Hansen and his toadies won\'t have anything to pester me about anymore.';
                                    break;
                                case 5:
                                    saying = 'It has to be around here! I know I saw it! Why did I ever say anything... now...';
                                    break;
                            }
            ...
            },
            {
                ...
                weight: 1,
                predicate: (game) => !townState.questDockingFinished,
                action: (game) => {
                    if (!townState.questDockingIntroduced) {
                        game.log('Nestled down a narrow alley barely big enough for carts, a small dock stretches out into the bay.'
                    ...
                    if (r <= 10) {
                        ...
                        switch (++townState.questDockingCount) {
                            case 1:
                                saying = 'You are doing me a huge favor here!';
                                break;
                            case 2:
                                saying = 'They won\'t even pick up the stuff they wrongly dropped off!';
                                break;
                            case 3:
                                saying = 'This must be some sort of plot to sabatoge my dock!';
                                break;
                            case 4:
                                saying = 'These crates won\'t move themselves... oh uh, thanks!';
                                break;
                            case 5:
                                saying = 'Hah! I saw one of their spies just over there earlier!';
                                break;
                            case 6:
                                saying = 'Here, wait over here. I set a trap for him this time...';
                                break;
                        }
                        ...
                        if (townState.questDockingCount >= 6) {
                            game.log('The trap springs, but doesn\'t slow down the inteloper who gets away and vanishes into the alley.'
...
//# sourceMappingURL=level01a.js.map